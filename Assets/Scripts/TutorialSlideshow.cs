...
public class TutorialSlideshow : MonoBehaviour {
	...
	void Start () {
		...
		DaySlides[2] = "Some pieces of furniture are special and activate when clicked on:\n" +
			...
			"Evil Portrait: Change the picture to a demon that frightens those who look at it.\n" +
				"...";
		DaySlides[3] = "You can spend money to buy new floors. Go up using the arrow on the right\n" +
		...
		DaySlides[4] = "Remember, the nicer the floors are, the more likely it is to bring in\n" +
			"wealthy visitors, who will drop more money overnight.";
		DaySlides[5] = "When you are ready, press \"Check In\" to bring in visitors.";
		NightSlides[0] = "When night starts, people check in and give you initial money.\n" +
		...
		NightSlides[1] = "At nighttime, your goal is to generate as much fear as possible...\n" +
		...
		NightSlides[2] = "There are 5 abilities you can use:\n" +
		...
		NightSlides[3] = "There are two residents to look out for: The thug, and the priest.\n" +
